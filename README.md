...
[![JetBrains Marketplace](https://img.shields.io/jetbrains/plugin/v/31459-slatewave?label=JetBrains%20Marketplace&color=5eead4)](https://plugins.jetbrains.com/plugin/31459-slatewave)
...
Listed at [plugins.jetbrains.com/plugin/31459-slatewave](https://plugins.jetbrains.com/plugin/31459-slatewave).
...
- **Editors** — [VSCode](https://github.com/kevinlangleyjr/vscode-slatewave) · [Xcode](https://github.com/kevinlangleyjr/xcode-slatewave) · [Sublime Text](https://github.com/kevinlangleyjr/sublime-text-slatewave) · [Zed](https://github.com/kevinlangleyjr/zed-slatewave) · [Neovim](https://github.com/kevinlangleyjr/neovim-slatewave) · [NvChad](https://github.com/kevinlangleyjr/nvchad-slatewave) · [Helix](https://github.com/kevinlangleyjr/helix-slatewave)
